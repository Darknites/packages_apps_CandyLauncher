...
import com.candy.candylauncher.AutoInstallsLayout.LayoutParserCallback;
...
import com.candy.candylauncher.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static String getAttributeValue(XmlResourceParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/com.candy.candylauncher", attribute);
        if (value == null) {
